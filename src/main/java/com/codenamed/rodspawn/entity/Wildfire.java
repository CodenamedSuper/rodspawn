package com.codenamed.rodspawn.entity;
...
public class Wildfire extends Monster {
    ...
    protected void registerGoals() {
        this.goalSelector.addGoal(4, new Wildfire.WildfireAttackGoal(this));
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Monster.createMonsterAttributes().add(Attributes.ATTACK_DAMAGE, 10).add(Attributes.MAX_HEALTH, 100).add(Attributes.MOVEMENT_SPEED, 0.23000000417232513).add(Attributes.FOLLOW_RANGE, 48.0);
    }
    ...
    static {
        DATA_FLAGS_ID = SynchedEntityData.defineId(Wildfire.class, EntityDataSerializers.BYTE);
    }
    ...
    static class WildfireAttackGoal extends Goal {
        ...
        public WildfireAttackGoal(Wildfire wildfire) {
                ...
                if (d0 < 4.0) {
                    ...
                    if (this.attackTime <= 0) {
                        ...
                        if (this.attackStep > 1) {
                            ...
                            for(int i = 0; i < 3; ++i) {
                                Vec3 vec3 = new Vec3(this.wildfire.getRandom().triangle(d1, 2.297 * d4), d2, this.wildfire.getRandom().triangle(d3, 2.297 * d4));
                                SmallFireball smallfireball = new SmallFireball(this.wildfire.level(), this.wildfire, vec3.normalize());
